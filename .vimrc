...
"go to declaration for python
Bundle 'danielroseman/pygd-vim'

"go to declaration for ruby
...
autocmd FileType rb 	    setlocal tabstop=2 shiftwidth=2
autocmd FileType erb 	    setlocal tabstop=2 shiftwidth=2
